package Restaurant.View.Component.Staff_Component;

import Restaurant.Model.ModelBan;
import Restaurant.Model.ModelNguoiDung;
import Restaurant.Model.ModelNhanVien;
import Restaurant.View.Form.Staff_Form.Staff.OrderFood_Form;
...
public class CardBanS extends javax.swing.JPanel {
    ...
    public CardBanS(ModelNguoiDung user,ModelNhanVien staff,ModelBan table,Restaurant.View.Form.MainForm main2) {
        this.user=user;
        this.staff=staff;
        this.table = table;
        this.main=main2;
    ...
    private void initComponents() {
        ...
        cmdAdj = new Restaurant.View.Swing.Button();
    ...
    private Restaurant.View.Swing.Button cmdAdj;
