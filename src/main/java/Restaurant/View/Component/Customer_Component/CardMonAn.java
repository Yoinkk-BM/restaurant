...
public class CardMonAn extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMinus = new Restaurant.View.Swing.ButtonOutLine();
        cmdAdd = new Restaurant.View.Swing.ButtonOutLine();
        cmdOrder = new Restaurant.View.Swing.Button();
        txtNum = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.ButtonOutLine cmdAdd;
    private Restaurant.View.Swing.ButtonOutLine cmdMinus;
    private Restaurant.View.Swing.Button cmdOrder;
    private javax.swing.JLabel img;
    private javax.swing.JLabel lbTitle;
    private javax.swing.JLabel lbValue;
    private Restaurant.View.Swing.MyTextField txtNum;
