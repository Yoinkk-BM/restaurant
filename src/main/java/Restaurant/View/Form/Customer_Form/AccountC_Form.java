...
import Restaurant.View.Swing.ImageAvatar;
import Restaurant.View.Swing.MyPasswordField;
...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new Restaurant.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new Restaurant.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new Restaurant.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new Restaurant.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.MyTextField txtdiemtl;
    private Restaurant.View.Swing.MyTextField txtdso;
    private Restaurant.View.Swing.MyTextField txtemail;
    private Restaurant.View.Swing.MyTextField txtmaKH;
    private Restaurant.View.Swing.MyPasswordField txtmatkhau;
    private Restaurant.View.Swing.MyTextField txtngayTG;
    private Restaurant.View.Swing.MyTextField txtrole;
    private Restaurant.View.Swing.MyTextField txttenKH;
