package Restaurant.View.Form.Staff_Form;

import Restaurant.Controller.ServiceStaff;
import Restaurant.Model.ModelNhanVien;
import Restaurant.Model.ModelNguoiDung;
import Restaurant.View.Dialog.MS_ChangePassword;
import Restaurant.View.Dialog.MS_ConfirmRename;
...
private MS_ChangePassword changepass;
    ...
    private void initComponents() {
        ...
        pic = new Restaurant.View.Swing.ImageAvatar();
        lbmaNV = new javax.swing.JLabel();
        txtngVL = new Restaurant.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new Restaurant.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new Restaurant.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new Restaurant.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new Restaurant.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new Restaurant.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new Restaurant.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new Restaurant.View.Swing.MyTextField();
        txtSDT = new Restaurant.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.Button cmdDMK;
    ...
    private Restaurant.View.Swing.ImageAvatar pic;
    private javax.swing.JLabel titleKH;
    private javax.swing.JLabel titleND;
    private Restaurant.View.Swing.MyTextField txtCvu;
    private Restaurant.View.Swing.MyTextField txtMaNQL;
    private Restaurant.View.Swing.MyTextField txtSDT;
    private Restaurant.View.Swing.MyTextField txtemail;
    private Restaurant.View.Swing.MyTextField txtmaNV;
    private Restaurant.View.Swing.MyPasswordField txtmatkhau;
    private Restaurant.View.Swing.MyTextField txtngVL;
    private Restaurant.View.Swing.MyTextField txtrole;
    private Restaurant.View.Swing.MyTextField txttenNV;
