package Restaurant.View.Form.Staff_Form.Staff;
...
import Restaurant.View.Dialog.MS_PaymentSuccess;
import Restaurant.View.Dialog.MS_Success;
import Restaurant.View.Form.MainForm;
import Restaurant.View.Main_Frame.Main_Admin_Frame;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bg = new Restaurant.View.Swing.PanelRound();
        lbTitle = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        cmdOK = new Restaurant.View.Swing.ButtonOutLine();
        cmdCancel = new Restaurant.View.Swing.ButtonOutLine();
        lbNgHD = new javax.swing.JLabel();
        txtidHD = new Restaurant.View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new Restaurant.View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new Restaurant.View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new Restaurant.View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new Restaurant.View.Swing.MyTextField();
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new Restaurant.View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new Restaurant.View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new Restaurant.View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.PanelRound bg;
    private Restaurant.View.Swing.ButtonOutLine cmdCancel;
    private Restaurant.View.Swing.Button cmdExportBill;
    private Restaurant.View.Swing.ButtonOutLine cmdOK;
    ...
    private Restaurant.View.Swing.Table tableCTHD;
    private Restaurant.View.Swing.MyTextField txtTienKH;
    private Restaurant.View.Swing.MyTextField txtTiengiam;
    private Restaurant.View.Swing.MyTextField txtTienmonan;
    private Restaurant.View.Swing.MyTextField txtTientra;
    private Restaurant.View.Swing.MyTextField txtTongtien;
    private Restaurant.View.Swing.MyTextField txtidHD;
    private Restaurant.View.Swing.MyTextField txtidKH;
