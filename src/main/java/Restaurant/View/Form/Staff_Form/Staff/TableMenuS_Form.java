...
import Restaurant.View.Form.Customer_Form.*;
...
import Restaurant.View.Component.Staff_Component.CardBanS;
...
public class TableMenuS_Form extends javax.swing.JPanel {
    ...
    public TableMenuS_Form(String floor,ModelNguoiDung user,MainForm main2) {
        this.floor=floor;
        this.user=user;
        this.main=main2;
