...
import Restaurant.View.Component.Customer_Component.CardMonAn;
import Restaurant.View.Form.MainForm;
import Restaurant.View.Swing.CustomScrollBar.ScrollBarCustom;
import Restaurant.View.Swing.WrapLayout;
...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdShowBill = new Restaurant.View.Swing.Button();
        lbTable = new javax.swing.JLabel();
        txtTableID = new Restaurant.View.Swing.MyTextField();
        cmdBack = new javax.swing.JLabel();
        TypeMenu = new javax.swing.JComboBox<>();
        lbKH = new javax.swing.JLabel();
        txtKH = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.MyTextField txtKH;
    private Restaurant.View.Swing.MyTextField txtSearch;
    private Restaurant.View.Swing.MyTextField txtTableID;
