...
import Restaurant.View.Main_Frame.Main_WarehouseStaff_Frame;
...
public class Ingredient_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tableNL = new Restaurant.View.Swing.Table();
        cmdAdd = new Restaurant.View.Swing.Button();
        cmdUpdate = new Restaurant.View.Swing.Button();
        cmdDelete = new Restaurant.View.Swing.Button();
    ...
    private Restaurant.View.Swing.Button cmdDelete;
    ...
    private Restaurant.View.Swing.Table tableNL;
