...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new Restaurant.View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new Restaurant.View.Swing.Table();
        cmdAdd = new Restaurant.View.Swing.Button();
        cmdCT = new Restaurant.View.Swing.Button();
    ...
    private Restaurant.View.Swing.Button cmdCT;
    ...
    private Restaurant.View.Swing.Table tablePXK;
    private Restaurant.View.Swing.MyTextField txtSearch;
    private Restaurant.View.Swing.MyTextField txtslPXK;
