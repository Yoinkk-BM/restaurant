...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    /**
     * Tải toàn bộ danh sách Phiếu Nhập Kho / Hóa Đơn từ Database lên JTable.
    ...
    private void initComponents() {
        ...
        tableHD = new Restaurant.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTHD = new Restaurant.View.Swing.Button();
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            // Lưu file
            String fileName = ".\\src\\ExportFile_Excel\\DanhsachHoaDon_"
    ...
    private Restaurant.View.Swing.Button cmdCTHD;
    ...
    private Restaurant.View.Swing.Table tableHD;
