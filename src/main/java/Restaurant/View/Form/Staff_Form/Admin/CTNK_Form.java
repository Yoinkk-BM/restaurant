...
import Restaurant.View.Form.Staff_Form.WarehouseStaff.*;
...
public class CTNK_Form extends javax.swing.JPanel {
     ...
     * Nhận đối tượng Phiếu Nhập Kho (pnk) từ màn hình trước truyền sang.
    ...
    private void initComponents() {
        ...
        txtidPN = new Restaurant.View.Swing.MyTextField();
    ...
    private Restaurant.View.Swing.MyTextField txtidPN;
