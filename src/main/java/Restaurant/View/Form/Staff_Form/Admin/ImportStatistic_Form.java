...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtprofit = new Restaurant.View.Swing.MyTextField();
        lbCus = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePNK = new Restaurant.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTNK = new Restaurant.View.Swing.Button();
        cmdExcel = new Restaurant.View.Swing.Button();
        ...
        lbTitle.setText("Thống kê Nhập Kho");
        ...
        lbprofit.setText("Chi phí Nhập Kho trong ngày");
        ...
        lbCus.setText("Danh sách Phiếu Nhập Kho");
        ...
        tablePNK.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã NK", "Mã NV", "Ngày Nhập Kho", "Tổng tiền"
            }
        ) {
        ...
        filter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Hôm nay", "Tháng này", "Năm này" }));
        filter.setToolTipText("Sắp xếp");
        ...
        cmdExcel.setText("XUẤT FILE EXCEL");
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("Danh sách Phiếu Nhập Kho");
            DefaultTableModel model = (DefaultTableModel) tablePNK.getModel();

            // Style cho header (chữ đậm)
            CellStyle headerStyle = workbook.createCellStyle();
            Font boldFont = workbook.createFont();
            boldFont.setBold(true);
            headerStyle.setFont(boldFont);

            // Thêm data cho header
            ...
            for (int row = 0; row < model.getRowCount(); row++) {
                ...
                for (int col = 0; col < model.getColumnCount(); col++) {
                    dataRow.createCell(col).setCellValue(model.getValueAt(row, col) + "");
                }
            }
            ...
            // Lưu file
            String fileName = ".\\src\\ExportFile_Excel\\DanhsachPNK_"
    ...
    private Restaurant.View.Swing.Button cmdCTNK;
    private Restaurant.View.Swing.Button cmdExcel;
    ...
    private Restaurant.View.Swing.Table tablePNK;
    private Restaurant.View.Swing.MyTextField txtSearch;
    private Restaurant.View.Swing.MyTextField txtprofit;
